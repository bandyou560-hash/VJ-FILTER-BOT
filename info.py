...
API_ID = int(environ.get('API_ID', '23326032'))
API_HASH = environ.get('API_HASH', '508102b04eccd2fff846b58516e0dbee')
BOT_TOKEN = environ.get('BOT_TOKEN', "8114721161:AAFyVGWX4et3nF58K7yYc_sFMSGeh9RvwNw")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://radare.arzfun.com/api/tg/photo?id=AgACAgQAAxkBAAEEX35okRKnErDKQs-z5-PIPEH9y7bvOQACosoxGyzJiVDn_-Eado4KnAEAAwIAA3kAAzYE')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7128232999').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5355842822').split()]  # For Multiple Id Use One Space Between Each.
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# This Channel Is For When User Start Your Bot Then Bot Send That User Name And Id In This Log Channel, Same For Group Also.
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-100274635747'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002636792002').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://opkio8491:CUx4uWMT1GvEhRBR@cluster0.u22vpiv.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Cima_Paradiso_Reg_Bot')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/cimaparadiso')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 't.me/cimaparadisomovieserie') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/kinanalyousef')
...
MSG_ALRT = environ.get('MSG_ALRT', 'Welcom My Friends 🤝')
